...
if __name__ == "__main__":
    ...
    retriever = InMemoryEmbeddingRetriever(
        load_document_store_with_embeddings(file_path='./data/DocMerged.json'), top_k = 1)
    ...
    Example: Question: What types of road improvements are planned for Greenmount Road in Belleville, Illinois? Answer: 'Additional lanes', 'Standard overlay/ADA improvements', 'Bridge replacement', 'Land acquisition', 'Utility adjustment'
